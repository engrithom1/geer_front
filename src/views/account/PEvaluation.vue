            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                            <td><a href="#" v-on:click="getEvaluationForm('mentee', 'Mentor / Coach Evaluation Form')">Mentor / Coach Evaluation Form</a></td>
                            </tr>
                            <tr>
                                <td><a href="#" v-on:click="getEvaluationForm('program', 'GEER Program Evaluation Form')">GEER Program Evaluation Form</a></td>
                            </tr>
                            <div v-if="this.modules_loading" class="loading-img container-fluid">
                                <div  class="friend-list friend-page-list">
                                    <img class="img-gif" width="300" src="/assets/images/loading/cupertino.gif" alt="#" />
                                </div>
                            </div>
                            <tr v-if="this.both">
                                <td><router-link to="/account/kpi-jobreadiness-entrepreneurship">KPIs Checklist for Participants venture into Entrepreneurship and Job Readness
                                    (To be filled every 3 months)</router-link></td>
                            </tr>
                            <tr v-if="this.job">
                                <td><router-link to="/account/kpi-jobreadiness">KPIs Checklist for Participants venture into Job Readiness
                                    (To be filled every 3 months)</router-link></td>
                            </tr>
                            <tr v-if="this.entr">
                                <td><router-link to="/account/kpi-entrepreneurship">KPIs Checklist for Participants venture into Entrepreneurship
                                    (To be filled every 3 months)</router-link></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="mt-5">
                        ...
                        <div v-if="this.mentee_form">
                            <div>
                                <p class="mt-3 mb-3">Please take time to provide feedback on the experience from your mentor/ coach.
                                     Your candid feedback will help us continuously improve the experience and relationship
                                      for a better impact. The information you provide shall be used with the highest 
                                      degree of confidentially and not otherwise 
                                </p>
                                <h2>PART A</h2>
                                <p>Please provide information and insight regarding the mentoring program you have participated 
                                    in by indicating a rating value for the following questions related to the activities
                                     and the nature of the mentoring process.</p>
                            </div>
                        ...
                        <div v-if="this.program_form">
                            <div>
                                <p class="mt-3 mb-3">Introduction Please take time to provide feedback on the experience
                                     from your GEER Program. Your candid feedback will help us continuously improve 
                                     the program for a better impact. The information you provide shall be used with 
                                     the highest degree of confidentially and not otherwise.  
                                </p>
                                <h2>PART A</h2>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async checkModuleTakes(){
            var response = await axios.post(this.$store.state.api_url + "/check-module-takes",{})
            .catch((errors) => {
            ...
            if (response.data.success) { 
                ...
                if(this.modules.length == 3){
                    ...
                    var objIndex = this.modules.findIndex(obj => obj.id == 12)
