        ...
        <div class="modal-content">
            ...
            <div class="modal-body m-2">
               ...
               <div class="row">
                ...
                <div v-if="!this.loading_info">
                <h2 class="mb-3 mt-3">Student Emplyerability</h2>
                <div class="row">
                    <div class="col-md-12 mb-2">
                    ...
                    <div class="col-md-12 mb-2">
                       <p class="v-p">13. What is your preferred career path way? :<br/> <strong>{{ this.employs.carrier_path }}</strong></p>
                    </div>
                    <div class="col-md-12 mb-2">
                       <p class="v-p">14. Are you currently engaged in any of the following.  :<br/> <strong>{{ this.employs.engaged }}</strong></p>
                    </div>
                    <div class="col-md-12 mb-2">
                    ...
                    <div class="col-md-12 mb-2">
                       <p class="v-p">18. If you plan to establish an enterprise, what type of enterprise do you want to establish?  :<br/> <strong>{{ this.employs.enterprise }}</strong></p>
                    </div>
                    <div class="col-md-12 mb-2">
